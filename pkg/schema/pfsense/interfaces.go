...
type Interface struct {
	...
	//
	// The three *Enable checkboxes are strings, not BoolFlag. pfSense stores a
	// ticked box as "Selected", which BoolFlag reads as false. interfaces.inc
	// treats any non-empty value as ticked, and so do the converters.
